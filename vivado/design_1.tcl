...
xilinx.com:user:yolo_axi_top:1.0\
...
\
  ...
  # Create instance: yolo_axi_top_0, and set properties
  set yolo_axi_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:yolo_axi_top:1.0 yolo_axi_top_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins yolo_axi_top_0/S_AXI]
  connect_bd_intf_net -intf_net yolo_axi_top_0_M_AXI_HP0 [get_bd_intf_pins yolo_axi_top_0/M_AXI_HP0] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net yolo_axi_top_0_M_AXI_HP1 [get_bd_intf_pins yolo_axi_top_0/M_AXI_HP1] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  ...
  [get_bd_pins yolo_axi_top_0/clk] \
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs yolo_axi_top_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces yolo_axi_top_0/M_AXI_HP0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces yolo_axi_top_0/M_AXI_HP0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces yolo_axi_top_0/M_AXI_HP1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces yolo_axi_top_0/M_AXI_HP1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
